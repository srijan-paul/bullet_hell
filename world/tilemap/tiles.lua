...
function Tile.init(...)
  ...
  Tile.Type = sugar.enum {
    ...
    'WALL_B', 'WALL_BR', 'WALL_V', 'WALL_VT', 'WALL_VB', 'WALL_HL', 'WALL_HR',
    'WALL_H1', 'WALL_H2', 'FLOOR1', 'FLOOR2', 'FLOOR3', 'FLOOR4', 'FLOOR5',
...
function Tile.Create(type)
  return {quad_index = type, collides = Tile.Collides[type], collider = nil}
end
